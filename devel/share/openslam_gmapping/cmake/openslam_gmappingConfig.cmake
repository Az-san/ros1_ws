...
if("TRUE" STREQUAL "TRUE")
  set(openslam_gmapping_SOURCE_PREFIX /root/ros1_ws/src/openslam_gmapping_backup)
...
if(NOT "/root/ros1_ws/src/openslam_gmapping_backup/include;/root/ros1_ws/devel/include " STREQUAL " ")
  set(openslam_gmapping_INCLUDE_DIRS "")
  set(_include_dirs "/root/ros1_ws/src/openslam_gmapping_backup/include;/root/ros1_ws/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openslam_gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros1_ws/src/openslam_gmapping_backup/${idir}'.  ${_report}")
    endif()
