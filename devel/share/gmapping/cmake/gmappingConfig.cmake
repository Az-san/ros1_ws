...
if("TRUE" STREQUAL "TRUE")
  set(gmapping_SOURCE_PREFIX /root/ros1_ws/src/slam_gmapping_backup/gmapping)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros1_ws/src/slam_gmapping_backup/gmapping/${idir}'.  ${_report}")
    endif()
